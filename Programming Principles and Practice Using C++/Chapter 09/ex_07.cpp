...
public:
	...
	void set_author(string book_author) { author
		= book_author; }		//
	void set_copyright(int copyright) { copyright_date = copyright; }	//
	void set_genre(Genre b){ genre = b; }
...
ostream& operator<<(ostream& os, const Book& b)
{
	...
	os << "Genre: " << genre_name(b.get_genre()) << endl;
...
Book::Book()
{
	...
	cout << "Genre -> 0:fiction, 1:nonfiction, 2:periodical, 3:biography, 4:children" << endl;
	bool exit = false;
	
	// keep getting input until user enters correct
	while (exit == false)
	{
		int choice;
		cin >> choice;
...
void Book::print() const
{
	...
	cout << "Genre: " << genre_name(genre) << endl;
...
string genre_name(int genre)
{
	...
	default:
		cout << "Warrning: genre_name(): int " << endl;
		break;
	}
	return name;
}
